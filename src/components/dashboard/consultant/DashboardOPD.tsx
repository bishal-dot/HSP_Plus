...
const OPDDashboard: React.FC = () => {
  ...
  return (
    <>
      {showAllPatients ? (
        <OPDALLPatients onClose={() => setShowAllPatients(false)} />
      ) : (
                ...
                <table className="min-w-[680px] w-full border-collapse">
                  <thead>
                    <tr className="bg-gradient-to-r from-blue-600 to-blue-700 text-white text-xs uppercase tracking-wide">
                      <th className="px-4 md:px-5 py-3.5 text-left font-semibold whitespace-nowrap">Actions</th>
                      ...
                      <th className="px-4 md:px-5 py-3.5 text-left font-semibold whitespace-nowrap hidden sm:table-cell">Age</th>
                      <th className="px-4 md:px-5 py-3.5 text-left font-semibold whitespace-nowrap hidden md:table-cell">Contact</th>
                          ...
                          >
                            <td className="px-4 md:px-5 py-3">
                              <button
                                ...
                                className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white rounded-lg text-xs font-medium transition shadow-sm"
                              >
                            ...
                            {/* Token bubble */}
                            <td className="px-4 md:px-5 py-3">
                              <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 text-xs font-bold">
                                {p.TokenNo}
                              </span>
                            </td>

                            <td className="px-4 md:px-5 py-3 font-mono text-xs text-slate-500 dark:text-slate-400 whitespace-nowrap">
                              {p.MRNo}
                            </td>

                            <td className="px-4 md:px-5 py-3">
                              <p className="font-semibold text-sm text-slate-800 dark:text-white whitespace-nowrap">{p.PatientName}</p>
                            </td>

                            <td className="px-4 md:px-5 py-3 text-xs text-slate-600 dark:text-slate-400 hidden sm:table-cell whitespace-nowrap">
                              {p.Age}
                            </td>

                            <td className="px-4 md:px-5 py-3 text-xs text-slate-600 dark:text-slate-400 hidden md:table-cell whitespace-nowrap">
                              {p.ContactNo}
                            </td>
